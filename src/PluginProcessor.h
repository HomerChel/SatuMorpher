...
{
public:
    SatuMorpherAudioProcessor();
    ~SatuMorpherAudioProcessor() override = default;
    ...
    //==============================================================================
    const juce::String getName() const override { return "SatuMorpher"; }
...
private:
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (SatuMorpherAudioProcessor)
